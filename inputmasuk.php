...
<h3 style="padding-top:10px">Tambah Data Surat Masuk</h3>

<form  class="form-group-center" method="post" action="proses_inputmasuk.php" enctype="multipart/form-data">
	<table>
        <tr>
			<td>Nomor Surat</td>
...
<tr/>
<td></td>
<td><a class="btn btn-warning" href="masuk.php">Kembali ke halaman Surat Keluar</a></td>
<br><br>
</div>
</div>
</form>
