...
<h3 style="padding-top:20px"> Edit Data Surat Keluar</h3>

<?php 
include 'koneksi.php';
$id = $_GET['id'];
$data = mysqli_query($koneksi,"select * from keluar where idsuratkeluar ='$id'");
while($d = mysqli_fetch_array($data)){
 ?>
<form method="post" action="proses_editkeluar.php" enctype="multipart/form-data">

	<table>
		<tr>
			<td><input type="hidden" class="form-control" name="idsuratkeluar" value ="<?php echo $d['idsuratkeluar'];?>"></td>
		</tr>
        <tr>
			<td>Nomor Surat</td>
