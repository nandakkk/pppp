...
<div class="container">
<div class="container" style="background-color:#0062cc; width:300px;">
 <div class="row justify-content-center">
<h3 style="padding-top:5px">Tambah Data Admin</h3>
<form  class="form-group-center" method="post" action="proses_inputadmin.php" enctype="multipart/form-data">
	<table>
        <tr>
			<td>Username</td>
...
<tr/>
<td></td>
<td><a class="btn btn-warning" href="admin.php">kembali ke halaman admin</a></td>
<br><br>
</div>
</div>
</form>
