...
include 'koneksi.php';
$id = $_GET['id'];
$data = mysqli_query($koneksi,"select * from admin where idadmin ='$id'");
while($d = mysqli_fetch_array($data)){
 ?>
<form method="post" action="proses_editadmin.php" enctype="multipart/form-data">
	<table>
	<tr>
			<td><input type="hidden" class="form-control" name="idadmin" value ="<?php echo $d['idadmin'];?>"></td>
		</tr>
<tr>
			<td>Username</td>
...
<br>
<a class="btn btn-success" href="admin.php">Kembali ke halaman utama</a>
</br>
<?php
